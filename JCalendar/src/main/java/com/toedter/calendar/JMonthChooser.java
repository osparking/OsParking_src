 ...
 * See lines 135, 331, 421 -- search key: osparking
 */
...
public class JMonthChooser extends JPanel implements ItemListener,
		...
		setMonth(Calendar.getInstance().get(Calendar.MONTH));
            ...
            public void increaseWidth(){
                        if (locale.getLanguage().equals(Locale.KOREAN.toString())) {
                                    ...
                                    comboBox.setPreferredSize(new Dimension(width + fontSize, height));                  
                        }
            }
            // osparking method ends here
	...
	public void setLocale(Locale l) {
		if (!initialized) {
			...
			initNames();
                        ...
                        // following single line added osparking
                        increaseWidth();
	}
	...
	public static void main(String[] s) {
		JFrame frame = new JFrame("MonthChooser");
                            ...
                            // following single line modified by osparking
                
                            // frame.getContentPane().add(new JMonthChooser()); // before modification
                
                            JMonthChooser jMC = new JMonthChooser();  // after modification
                            jMC.setLocale(Locale.KOREAN);
                            jMC.setFont(new java.awt.Font("Dotum", 1, 14));
                            frame.getContentPane().add(jMC);
