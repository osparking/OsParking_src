 ...
 * See line 76, -- search key: osparking
 */
...
public class JYearChooser extends JSpinField {
    ...
    public void setYear(int y) {
        ...
        // Following 13 lines are added osparking
        ...
        {
            textEditor = (JTextField)editor;
            textEditor.setBorder(BorderFactory.createEmptyBorder(0, 0, 0, 10));
            after = textEditor.getMargin();
        }
