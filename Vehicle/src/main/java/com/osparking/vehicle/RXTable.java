...
/**
 * The whole file is from : http://www.camick.com/java/source/RXTable.java
 * Above page is linked from here:
 * https://tips4java.wordpress.com/2008/10/20/table-select-all-editor/
 * -- Posted by Rob Camick on October 20, 2008
 * Reference: 
 * http://stackoverflow.com/questions/4611363/how-to-select-all-text-in-jtable-cell-when-editing
 * 
 */
