...
public class ControlEnums {
    ...
    public enum DialogMsg {
        ...
        UNIT_DEL_1("다음 호실과 관련 차주들을 삭제합니까?", "Want to delete Unit and Car Owners?"),
        UNIT_DEL_2(" - 호실번호 : ", " - Unit No.: "),
    ...
    public enum LabelContent {
        ...
        GATE_NAME_LABEL2("입구 이름 길이 한계를 초과하였습니다.", 
                "Gate name limit has been exceeded."),
        ...
        LIMIT_LABEL(" - 길이 한계 : ", " - Length Limit : "),
    ...
    public enum MsgContent {
        ...
        AFFILI_DEL_L1("다음 소속들과 속한 차주 정보를 삭제합니까?", 
                "Want to delete affiliations and related car owners?"),
        AFFILI_DEL_L2("다음 부서 및 속한 차주 정보를 삭제합니까?", 
                "Want to delete lower affiliation and related car owner records?"),
        ...
        BLDG_DIAG_L21(" - 건물번호 : ", " - Building No.: "),
        ...
        BLDG_DELETE_L1("다음 건물과 관련 자료들을 삭제합니까?", 
                "Want to delete this building & related records?"),
        BLDG_DELETE_L3(" - 호실 건수 : ", " - Number of Rooms : "),
    ...
    public enum DialogMessages {
        ...
        LEVEL2_NAME_DIALOG(" - 부서", " - Lower Affiliation"),
        OWNER_RECORD_DIALOG(" - 차주 건수 : ", " - Car Owner Records : "),
    ...
    public enum ComboBoxItemTypes {
        ...
        BASIC_LOGGING_CB_ITEM("기본 로깅", "Basic Logging"),
